...
class ReadingLogValidatorTest {
    ...
    @Nested
    @DisplayName("Test ReadingLogValidator supports")
    class ReadingLogValidatorSupportsTest {
        /**
    ...
    @Nested
    @DisplayName("Test ReadingLogValidator validate")
    class ReadingLogValidatorValidateTest {
